...
$query = $pdo->query("SELECT * FROM categorias WHERE slug = '$categoria_get'");
$res = $query->fetchAll(PDO::FETCH_ASSOC);

$id_categoria = @$res[0]['id_categorias'];
?>
            ...
            <div class="col-lg-9 col-md-7">
                ...
                <div class="row mt-4">
                    ...
                    if ($categoria_get != "") {
                        ...
                        $query = $pdo->query("SELECT * FROM sub_categorias order by nome");
                    }
                            ...
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <a href="produtos-<?php echo $nome_url ?>">
                                        <h5><?php echo $nome ?></h5>
                                        <h6><?php echo $total_itens ?> Produtos</h6>
                                    </a>
                                </div>
                            </div>
                        </div>
